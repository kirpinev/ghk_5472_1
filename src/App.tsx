...
const offline: Product[] = [
  ...
  },
  {
    ...
    price: "от 103 285,00 ₽ до 794 355,80 ₽",
    type: "Оффлайн",
  ...
  },
  {
    ...
    price: "от 10 103,83 ₽ до 68 995,48 ₽",
    type: "Оффлайн",
...
const online: Product[] = [
  ...
  },
  {
    ...
    price: "от 14 276 ₽ до 44 895 ₽ в зависимости от региона",
    type: "Онлайн",
    text:
  ...
  },
  {
    ...
    price: "от 7 138 ₽ до 50 448 ₽ для вашего региона",
    type: "Онлайн",
  ...
  {
    title: "Дополнительные выплаты для Москвы",
    price: "Размер выплаты различается в зависимоти от типа",
    type: "Онлайн",
    text: "Подайте заявление на нужную выплату на mos.ru и укажите в нём реквизиты счёта",
  },
  {
    title: "Единовременное пособие при передаче ребенка на воспитание в семью",
    price: "от 26 941,71 ₽ до 205 856,61 ₽",
    type: "Онлайн",
